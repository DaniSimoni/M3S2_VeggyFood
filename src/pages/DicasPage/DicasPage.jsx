...
export const DicasPage = () =>{
    ...
    return (
        ...
        <Styled.Lista>
            <Styled.ItensLista><FaCheck/> Temperos, deve remover as folhas prestas e colocar as folhas murchas em um pote com água.</Styled.ItensLista>
